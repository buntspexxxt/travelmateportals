#!/bin/sh
# Fallback Script for bluespot
# ERROR: Captured HTML was empty (0 bytes). Portal blocked or dropped the connection.

# --- WGET DEBUG LOG ---
# === Trying http://detectportal.firefox.com/ ===
# Cannot open cookies file '/tmp/portal_tmp_1782129791/cookies.txt': No such file or directory
# --2026-06-22 14:03:11--  http://detectportal.firefox.com/
...
# --2026-06-22 14:03:16--  http://neverssl.com/
...
# --2026-06-22 14:03:21--  http://www.msftconnecttest.com/connecttest.txt
...
# --2026-06-22 14:03:26--  http://connectivitycheck.gstatic.com/generate_204
