#!/bin/sh
# Fallback Script for Stadtwerke_Neuss
# ERROR: Captured HTML was empty (0 bytes). Portal blocked or dropped the connection.

# --- WGET DEBUG LOG ---
# === Trying http://detectportal.firefox.com/ ===
# Cannot open cookies file '/tmp/portal_tmp_1782217165/cookies.txt': No such file or directory
# --2026-06-23 14:19:25--  http://detectportal.firefox.com/
...
# --2026-06-23 14:19:30--  http://neverssl.com/
...
# --2026-06-23 14:19:35--  http://www.msftconnecttest.com/connecttest.txt
...
# --2026-06-23 14:19:40--  http://connectivitycheck.gstatic.com/generate_204
