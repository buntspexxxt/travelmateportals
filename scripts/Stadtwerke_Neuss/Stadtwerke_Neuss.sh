...
# Fetch the initial portal page to extract dynamic form fields
...
# Submit form with required fields for Hotsplots authentication
RESPONSE_CODE=$(curl -k -L -s -A "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36" \
